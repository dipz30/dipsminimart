            ...
            <div class="centerbar" id="centerbar">
				<div class="addsection">
					<form>
						 <a href="javascript:void(0)" onclick="toggle_visibility('popup-box1')">
							<input type="button" id="btnadd" value="+ Add Customer" style="width: 14%; height: 95%; margin-top: 1px; margin-left: 86%;" />
						 </a>
					</form>
				</div>
				<div class="productinfo">
					<tbody>
						...
						<tr>
						 <th colspan="7" align="center" height="20px" style="border-bottom:1px solid #033; background: #033; color:#FFF;"> &nbsp;&nbsp;&nbsp;&nbsp;Customer Information</th>
						</tr>
						...
						<tr align="center" style="height:20px">
							...
							<a href="delete_customer.php?id=<?php echo md5($row1['ID']);?>"><input type="button" value="Delete" style="width:50; height:25px; color:#FFF; background: #900; border:1px solid #900; border-radius:3px;"></a>
							</td>
					  </tr>
						<?php
				...
				<div id="popup-wrapper">
					<div id="popup-container">
						...
						<tr>
							...
							<td><input type="text" id="txtbox" name="quantity" placeholder="Contact" required><br>
							</td>
						</tr>
							
						<tr>
							<td align="right">Address:</td>
							<td><input type="text" id="txtbox" name="purchase" placeholder="Address" required><br>
							</td>
						</tr>
							
						<tr>
							<td align="right">Note:</td>
							<td><input type="text" id="txtbox" name="retail" placeholder="Note" required><br>
							</td>
						</tr>
