    ...
    <body>
        <div class="bodywrap">
            <div class="topbar">
               ...
               <div id="head3"><form action="result_supplier.php" method="get" ecntype="multipart/data-form"><input type="text" id="searchbar" name="searchbox" placeholder="Search Suppliers" style="width: 78%; height: 70%; font-style: italic; text-align: center;"><input type="submit" id="searchbtn" name="searchbtn" value="Search" style="width: 20%; height: 71%;"></form></div>
            </div>
            <div class="leftbar">
                 <ul class="sub-menu2">
            ...
            <div class="centerbar" id="centerbar"><div class="addsection">
					<form>
						 <a href="javascript:void(0)" onclick="toggle_visibility('popup-box1')">
							<input type="button" id="btnadd" value="+ Add Supplier" style="width: 14%; height: 95%; margin-top: 3px; margin-left: 86%;" />
						 </a>
					</form>
				</div>
				<div class="productinfo">
					<tbody>
						...
						<tr>
						 <th colspan="7" align="center" height="20px" style="border-bottom:1px solid #033; background: #5a7155; color:#FFF;">&nbsp;&nbsp;&nbsp;&nbsp;Supplier Information Table</th>
						</tr>
