            ...
            <div class="centerbar" id="centerbar">
				...
				<div class="productinfo">
					<tbody>
						...
						<td style="border-bottom:1px solid #333;">Php <?php echo $row1['Purchase']; ?> </td>
						<td style="border-bottom:1px solid #333;">Php <?php echo $row1['Retail']; ?> </td>
						<td style="border-bottom:1px solid #333;"> <?php echo $row1['Supplier']; ?> </td>
						<td style="border-bottom:1px solid #333;">
							<a href="edit_item.php?id=<?php echo md5($row1['ID']);?>"><input type="button" value="Edit" style="width:50px; height:20; color:#FFF; background:#069; border:1px solid #0da223; border-radius:3px;"></a>|
							|<a href="delete_item.php?id=<?php echo md5($row1['ID']);?>"><input type="button" value="Delete" style="width:50px; height:20; color:#FFF; background: #900; border:1px solid #900; border-radius:3px;"></a>
						</td>
					  </tr>
						<?php
